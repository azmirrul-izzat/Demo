...
try {
    ...
    //String target = "/content/demo/en_au/where-to-buy/jcr:content/par/where-to-buy-component";
    //String target = "/content/demo/global/global-contact-information/jcr:content/par/container_fluid_plac/par/global_contact_infor";
    if (target != null) {
