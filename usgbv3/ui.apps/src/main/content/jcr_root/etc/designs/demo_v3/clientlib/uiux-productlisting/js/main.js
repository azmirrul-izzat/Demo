...
$(document).ready(function(){
    ...
    stickySidebar = new StickySidebar('.make-sticky', {
        topSpacing: 105,
        bottomSpacing: 0,
    ...
    $(document).on("scroll", function(){
        if(alignStickySidebar){
            updateSticky();
        }
        alignStickySidebar = false;
    });
});
...
$(document).on('click', '#product-listing-form button[type="submit"]', function (e) {
    ...
    btnSubmit = this;
    submitResults();
    scrollToTarget('.make-sticky_limit');
});
//mobile
