...
//         var tempURL = "/etc/designs/demo_v3/clientlib/uiux-all-js/js/json/product-compare-one.html";
    ...
    $(document).ready(function () {
        ...
        function productListingFeatures() {
            ...
            function productListingResult() {
                ...
                $.ajax({
                    //url: "/etc/designs/demo_v3/clientlib/uiux-all-js/js/json/gallery-filter-one.json",
                    url: "/etc/designs/demo_v3/clientlib/uiux-all-js/js/json/product-listing-filter.json",
                    type: "GET",
                    cache: false,
                    success: function (response) {
                        // store in global
    ...
    $(document).ready(function () {
        ...
        if ($('.gallery-listing-sidebar').length) {
            ...
            function galleryResult() {
                ...
                $.ajax({
                    //url: "/etc/designs/demo_v3/clientlib/uiux-all-js/js/json/gallery-filter.json",
                    url: "/etc/designs/demo_v3/clientlib/uiux-all-js/js/json/test-gallery.json",
                    type: "GET",
                    cache: false,
                    success: function (response) {
                        // store in global
                ...
                $.ajax('https://geoip.nekudo.com/api')
                    .then(
                        function success(response) {
                            ...
                            $.ajax({
                                url: "/etc/designs/demo_v3/clientlib/uiux-all-js/js/json/global-landing-my.json",
