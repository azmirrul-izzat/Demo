...
(function () {
    ...
    if($('#filter-list-controller').length > 0){
        ...
        function createMarker(latlng, companyName, address1, address2, phoneNumber, email, directionUrl){
            var var_pin = '/content/dam/demo/Global/Website/Images/v3/component/marker.png';
            ...
            google.maps.event.addListener(marker, 'click', function () {
                ...
                for (var i = 0; i < markers.length; i++) {
                    markers[i].setIcon('/content/dam/demo/Global/Website/Images/v3/component/marker.png');
                }

                // opening the Info Window in the current map and at the current marker location.
                marker.setIcon('/content/dam/demo/Global/Website/Images/v3/component/marker-active.png');
            ...
            google.maps.event.addListener(map, 'click', function () {
                ...
                marker.setIcon('/content/dam/demo/Global/Website/Images/v3/component/marker.png');
            });
                    ...
                    if(markersData.length > 0){
                        ...
                        if(response.hasOwnProperty('proximityResult')){
                            proximityLocationMarker = new google.maps.Marker({
                                ...
                                icon: '/content/dam/demo/Global/Website/Images/v3/component/icon_marker_yellow.png',
                                map: map
                            });
                            map.setCenter(pos);
                            map.setZoom(14);
        ...
        function geolocation(callback){
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    var var_pin = '/content/dam/demo/Global/Website/Images/v3/component/icon_marker_red.png';
