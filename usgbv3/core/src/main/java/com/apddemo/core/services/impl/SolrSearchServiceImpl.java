...
import com.apddemo.core.configuration.SolrServerConfiguration;
import com.apddemo.core.services.SolrSearchService;
import com.apddemo.core.utils.SolrUtils;
import com.apddemo.core.utils.StringUtils;

@Component(immediate = true, service = SolrSearchService.class
        , configurationPid = "com.apddemo.core.services.impl.SolrSearchServiceImpl")
